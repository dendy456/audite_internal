        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="{{ url('admin') }}"> <i class="menu-icon fa fa-home"></i>Home </a>
                    </li>
                    <li>
                        <a href="{{ route('periode.index') }}"> <i class="menu-icon fa fa-table"></i>Periode Audit</a>
                    </li>
                    <li>
                        <a href="{{ route('unit.index') }}"> <i class="menu-icon fa fa-table"></i>Unit Audit</a>
                    </li>
                    <li>
                        <a href="{{ route('profile') }}"> <i class="menu-icon fa fa-user"></i>My Profile</a>
                    </li>
